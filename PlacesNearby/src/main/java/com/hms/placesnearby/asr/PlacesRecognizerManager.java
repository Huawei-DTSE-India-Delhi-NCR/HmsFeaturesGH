...
package com.hms.placesnearby.asr;
...
public class PlacesRecognizerManager {
    ...
    public PlacesRecognizerManager(Context context, String language, onResultsReady listener) {
        try {
            mListener = listener;
