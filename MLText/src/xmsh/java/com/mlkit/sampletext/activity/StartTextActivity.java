...
import com.mlkit.sampletext.activity.adapter.GridViewAdapter;
import com.mlkit.sampletext.activity.entity.GridViewItem;
import com.mlkit.sampletext.util.Constant;

import java.util.ArrayList;
import java.util.List;

public final class StartTextActivity extends BaseActivity
    ...
    private void initClickEvent() {
        ...
        this.mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        startActivity(new Intent(StartTextActivity.this, TranslateActivity.class));
                        break;
                    case 1:
                        startActivity(new Intent(StartTextActivity.this, AsrAudioActivity.class));
                        break;
                    case 2:
                        startActivity(new Intent(StartTextActivity.this, TtsAudioActivity.class));
                        break;
                    case 3:
                        startActivity(new Intent(StartTextActivity.this, AudioFileTranscriptionActivity.class));
                        break;
                    case 4:
                        // BCR
                        startActivity(new Intent(StartTextActivity.this, BankCardRecognitionActivity.class));
                        break;
                    case 5:
                        // GCR
                        startActivity(new Intent(StartTextActivity.this, GeneralCardRecognitionActivity.class));
                        break;
                    case 6:
                        // Text recognition
                        startActivity(new Intent(StartTextActivity.this, TextRecognitionActivity.class));
                        break;
                    case 7:
                        // ICR
                        startActivity(new Intent(StartTextActivity.this, IDCardRecognitionActivity.class));
                        break;
                    case 8:
                        // Document recognition
                        final Intent intent = new Intent(StartTextActivity.this, RemoteTextDetectionActivity.class);
        ...
        /*this.mGridView.setOnItemClickListener((parent, view, position, id) -> {
            switch (position) {
                ...
                case 8:
                    // Document recognition
                    final Intent intent = new Intent(StartTextActivity.this, RemoteDetectionActivity.class);
                    intent.putExtra(Constant.MODEL_TYPE, Constant.CLOUD_DOCUMENT_TEXT_DETECTION);
                    startActivity(intent);
                    break;
                default:
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.setting_img) {
            this.startActivity(new Intent(StartTextActivity.this, SettingActivity.class));
        }
    }
    ...
    private boolean allPermissionsGranted() {
        for (String permission : this.getRequiredPermissions()) {
            if (!StartTextActivity.isPermissionGranted(this, permission)) {
                return false;
            }
        }
        return true;
    ...
    private void getRuntimePermissions() {
        ...
        if (!allNeededPermissions.isEmpty()) {
            ActivityCompat.requestPermissions(
                    this, allNeededPermissions.toArray(new String[0]), StartTextActivity.PERMISSION_REQUESTS);
        }
    }
    ...
    private static boolean isPermissionGranted(Context context, String permission) {
        if (ContextCompat.checkSelfPermission(context, permission)
            ...
            Log.i(StartTextActivity.TAG, "Permission granted: " + permission);
            return true;
        }
        Log.i(StartTextActivity.TAG, "Permission NOT granted: " + permission);
        return false;
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode != StartTextActivity.PERMISSION_REQUESTS) {
            return;
        }
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(this.getString(R.string.settings), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.setData(Uri.parse("package:" + StartTextActivity.this.getPackageName()));
                            StartTextActivity.this.startActivityForResult(intent, 200);
                            StartTextActivity.this.startActivity(intent);
                        }
                    })
                    .setNegativeButton(this.getString(R.string.cancel), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            StartTextActivity.this.finish();
                        }
                    }).create();
            dialog.show();
        }
