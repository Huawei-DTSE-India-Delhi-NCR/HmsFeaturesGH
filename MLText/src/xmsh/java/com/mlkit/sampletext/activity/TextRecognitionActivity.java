...
import com.mlkit.sampletext.camera.CameraConfiguration;
import com.mlkit.sampletext.camera.LensEngine;
import com.mlkit.sampletext.camera.LensEnginePreview;
import com.mlkit.sampletext.processor.LocalDataProcessor;
import com.mlkit.sampletext.transactor.LocalTextTransactor;
import com.mlkit.sampletext.util.BitmapUtils;
import com.mlkit.sampletext.util.Constant;
import com.mlkit.sampletext.util.SharedPreferencesUtil;
...
public final class TextRecognitionActivity extends BaseActivity
    ...
    private String textType = Constant.POSITION_EN;
    ...
    private void createAddPictureDialog() {
        ...
        final Intent intent = new Intent(TextRecognitionActivity.this, RemoteTextDetectionActivity.class);
