...
import com.mlkit.sampletext.activity.dialog.RecordDialog;
import com.mlkit.sampletext.record.AudioManager;
import com.mlkit.sampletext.record.RecordingListener;
import com.mlkit.sampletext.util.FileUtils;
import com.mlkit.sampletext.util.UriFileInfoUtils;
...
public class AudioFileTranscriptionActivity extends BaseActivity implements View.OnClickListener {
    ...
    public AudioFileTranscriptionActivity() {
        super(true);
    }
