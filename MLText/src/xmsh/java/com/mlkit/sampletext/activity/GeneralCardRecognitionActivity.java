...
import com.mlkit.sampletext.activity.entity.GeneralCardResult;
import com.mlkit.sampletext.processor.gcr.GeneralCardProcessor;
import com.mlkit.sampletext.processor.gcr.homecard.HomeCardProcessor;
import com.mlkit.sampletext.processor.gcr.hongkong.HKIdCardProcessor;
import com.mlkit.sampletext.processor.gcr.passcard.PassCardProcessor;

import java.io.IOException;

public class GeneralCardRecognitionActivity extends BaseActivity implements View.OnClickListener {

    public GeneralCardRecognitionActivity() {
        super(true);
    }
    ...
    RadioGroup.OnCheckedChangeListener radioListener = new RadioGroup.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            if (checkedId == R.id.passCard) {
                updateCardType(CardType.PASSCARD);
            } else if (checkedId == R.id.HKIdCard) {
                updateCardType(CardType.HKIDCARD);
            } else if (checkedId == R.id.comeHomeCard) {
