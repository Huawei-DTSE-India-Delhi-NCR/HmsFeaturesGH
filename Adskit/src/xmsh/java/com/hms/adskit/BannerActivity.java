...
public class BannerActivity extends BaseActivity {
    ...
    private BannerAdSize getBannerAdSize(int checkedId) {
        ...
        if (checkedId == R.id.size_320_50) {
            adSize = BannerAdSize.BANNER_SIZE_320_50;
        } else if (checkedId == R.id.size_320_100) {
            adSize = BannerAdSize.BANNER_SIZE_320_100;
        } else if (checkedId == R.id.size_300_250) {
            adSize = BannerAdSize.BANNER_SIZE_300_250;
        } else if (checkedId == R.id.size_smart) {
            adSize = BannerAdSize.BANNER_SIZE_SMART;
        } else if (checkedId == R.id.size_360_57) {
            adSize = BannerAdSize.BANNER_SIZE_360_57;
        } else if (checkedId == R.id.size_360_144) {
    ...
    private int getBannerViewBackground(int checkedId) {
        ...
        if (checkedId == R.id.color_white) {
            color = Color.WHITE;
        } else if (checkedId == R.id.color_black) {
            color = Color.BLACK;
        } else if (checkedId == R.id.color_red) {
            color = Color.RED;
        } else if (checkedId == R.id.color_transparent) {
