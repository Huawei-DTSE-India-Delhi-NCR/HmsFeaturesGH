...
import com.mlkit.sampletext.activity.adapter.skeleton.GridViewAdapterSketlon;
...
public class  TemplateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageProcessor = new LocalSketlonTranstor(new MLSkeletonAnalyzerSetting.Factory().create(), this);
        initData();
        ...
        imageProcessor.detectInImage(frame).addOnSuccessListener(new OnSuccessListener<List<MLSkeleton>>() {
            ...
            public void onSuccess(List<MLSkeleton> results) {
                ...
                if (results.size() > 0) {
                    ...
                    templateDataMap.put("key" + StartActivity.getCount(), gridItem);
                    StartActivity.setCount();
                    templateDatalist.add(gridItem);
                    mAdapter.notifyDataSetChanged();
                } else {
