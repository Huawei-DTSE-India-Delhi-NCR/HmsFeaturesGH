...
import com.mlkit.sampletext.activity.adapter.skeleton.GridItem;
import com.mlkit.sampletext.activity.entity.GridViewItem;
import com.mlkit.sampletext.transactor.LocalSketlonTranstor;
import com.mlkit.sampletext.util.BitmapUtils;
import com.mlkit.sampletext.util.Constant;
import com.mlkit.sampletext.views.graphic.CameraImageGraphic;
import com.mlkit.sampletext.views.graphic.LocalSkeletonGraphic;
...
public final class StartActivity extends BaseActivity
    ...
    private static final int[] ICONS = {R.drawable.icon_segmentation, R.drawable.icon_face,
            R.drawable.icon_object, R.drawable.icon_classification,
            R.drawable.icon_landmark, R.drawable.icon_skeleton};

    private static final int[] TITLES = {R.string.image_segmentation, R.string.face_detection,
            R.string.object_detection, R.string.image_classification,
            R.string.landmark, R.string.skeletlon};
