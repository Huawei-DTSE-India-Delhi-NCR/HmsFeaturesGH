...
import com.mlkit.sampletext.transactor.RemoteLandmarkTransactor;
...
public final class RemoteDetectionActivity extends BaseActivity implements OnClickListener {
    ...
    private void initTitle() {
        ...
        if (this.selectedMode.equals(Constant.CLOUD_IMAGE_CLASSIFICATION)) {
            ...
            setTitle(this.getResources().getText(R.string.cloud_classification));
            ...
            setTitle(this.getResources().getText(R.string.landmark_s));
        }
    }
